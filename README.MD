...
| <a name="input_custom_otel_config"></a> [custom\_otel\_config](#input\_custom\_otel\_config) | n/a | <pre>list(object({<br>    otel_config_file_path = string<br>  }))</pre> | <pre>[<br>  {<br>    "otel_config_file_path": null<br>  }<br>]</pre> | no |
