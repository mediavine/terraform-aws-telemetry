...
| [aws_lb_listener.health_check](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener) | resource |
...
| <a name="input_otel_collector_image"></a> [otel\_collector\_image](#input\_otel\_collector\_image) | The image of the otel collector | `string` | `"public.ecr.aws/aws-observability/aws-otel-collector:v0.38.1"` | no |
